...
<p style="color: #008080; font-style: italic; font-size: 1.1em;">
  🌟 <strong>Ph.D. Openings (Spring/Fall 2027):</strong><br>
  I am recruiting motivated students in <em>efficient graph deep learning, efficient graph-infused LLM serving, and security in deep graph learning</em>. 
...
- **Yue Dai***, Liang Liu*, Xulong Tang, Youtao Zhang, Jun Yang. 2025. Memfreezing: A Novel Adversarial Attack on Temporal Graph Neural Networks under Limited Future Knowledge. The Thirteenth International Conference on Learning Representations (**ICML'2025**)
